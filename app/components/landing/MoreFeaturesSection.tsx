      ...
      <div className='max-w-6xl mx-auto px-4'>
        <div className='text-center mb-12'>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Plus {' '}
                <span className="bg-linear-to-r from-blue-400 via-blue-500 to-blue-600  bg-clip-text text-transparent">More Features</span>
            </h2>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:bg-gray-900/70 hover:border-gray-700 transition-all'>
                ...
                <p className='text-gray-400'>
                    Track meeting pattens, participation rates and productivity.
                </p>
            </div>
        </div>
      </div>
