  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              <div className="2-8 h-8 bg-blue-600 rounded-lg items-center justify-center">
      ...
      <section className="py-20 px-4 bg-black">
        <div className="max-2-4xl mx-auto text-center">
          <div className="group relative mx-auto flex w-fit items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#3b82f61f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#3b82f63f] mb-8">
            <span
              className={cn(
                "absolute inset-0 block h-full w-full animate-gradient rounded-[inherit] bg-linear-to-r from-[#3b82f6]/50 via-[#1d4ed8]/50 to-[#3b82f6]/50 bg-size-[300%_100%] p-1px",
              )}
              style={{
                WebkitMask:
