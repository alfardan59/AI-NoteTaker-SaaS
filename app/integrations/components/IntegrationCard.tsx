...
const IntegrationCard = ({integration, onConnect, onDisconnect, onSetup}:IntegrationCardProps) => {
                ...
                <div>
                    <h3 className='font-semibold text-foreground'>{integration.name}</h3>
                    {
                        integration.connected && (
                            <span className='text-xs bg-green-500/20 text-green-400 px-2 py-2 rounded-full'>Connected</span>
                        )
                    }
                </div>
                <div>
